...
# for i in range(256):
i = 255
num = np.array(i).astype(np.uint8)
it1 = np.bitwise_and(np.right_shift(num, 0), 3).astype(np.uint8)
it2 = np.bitwise_and(np.right_shift(num, 2), 3).astype(np.uint8)
it3 = np.bitwise_and(np.right_shift(num, 4), 3).astype(np.uint8)
it4 = np.bitwise_and(np.right_shift(num, 6), 3).astype(np.uint8)
