...
class OutputFile:
    ...
    def write_tensor_data(self, ftype: GGMLFileType, model: LazyModel, concurrency: int, kcfg_path: str) -> None:
        ...
        for i, ((name, lazy_tensor), ndarray) in enumerate(zip(model.items(), ndarrays)):
            ...
            if i2_scale is not None:
                ...
                ndarray = preprocess_weights(ndarray, 2, 4, kcfg_path)
    ...
    def write_all(
        ...
        pad_vocab: bool = False, kcfg_path: str = '',
    ) -> None:
        check_vocab_size(params, vocab, pad_vocab=pad_vocab)
        ...
        # tensor data
        of.write_tensor_data(ftype, model, concurrency, kcfg_path)
...
def main(args_in: list[str] | None = None) -> None:
    ...
    OutputFile.write_all(outfile, ftype, params, model, vocab, special_vocab,
                         concurrency=args.concurrency, endianess=endianess, pad_vocab=args.pad_vocab, kcfg_path=args.kcfg)
    logger.info(f"Wrote {outfile}")
